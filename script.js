...
// =========================
// PRODUCTS RENDER (FAST LOAD FROM STORAGE JSON)
// =========================
...
window.addEventListener("load",()=>{
  ...
  if(logged==="true") showPage("adminPanel"); else showPage("productsPage");
});
...
// =========================
// ADMIN: Service Submissions + Orders
// =========================
